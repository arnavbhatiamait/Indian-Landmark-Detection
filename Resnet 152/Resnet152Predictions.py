...
# %%
new_model = tf.keras.models.load_model('resnet_model152-2.h5')
...
# %%
size=(224,224)
img_load=imagearray("archive - Copy - Copy\Indian-monuments\images//test\qutub_minar\img4.jpg",size)
