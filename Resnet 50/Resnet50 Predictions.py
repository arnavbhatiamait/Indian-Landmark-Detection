...
# %%
new_model = tf.keras.models.load_model('resnet_model745.h5')
...
# %%
size=(224,224)
img_load=imagearray("archive - Copy - Copy\Indian-monuments\images/test/tajmahal\84.jpg",size)
